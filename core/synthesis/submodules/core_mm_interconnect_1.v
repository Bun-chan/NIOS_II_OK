...
module core_mm_interconnect_1 (
	...
	wire  [11:0] mm_clock_crossing_bridge_0_m0_translator_avalon_universal_master_0_address;       // mm_clock_crossing_bridge_0_m0_translator:uav_address -> mm_clock_crossing_bridge_0_m0_agent:av_address
	...
	wire  [11:0] sysid_qsys_0_control_slave_agent_m0_address;                                      // sysid_qsys_0_control_slave_agent:m0_address -> sysid_qsys_0_control_slave_translator:uav_address
	...
	wire  [84:0] sysid_qsys_0_control_slave_agent_rf_source_data;                                  // sysid_qsys_0_control_slave_agent:rf_source_data -> sysid_qsys_0_control_slave_agent_rsp_fifo:in_data
	...
	wire  [84:0] sysid_qsys_0_control_slave_agent_rsp_fifo_out_data;                               // sysid_qsys_0_control_slave_agent_rsp_fifo:out_data -> sysid_qsys_0_control_slave_agent:rf_sink_data
	...
	wire  [83:0] cmd_mux_src_data;                                                                 // cmd_mux:src_data -> sysid_qsys_0_control_slave_agent:cp_data
	wire         cmd_mux_src_ready;                                                                // sysid_qsys_0_control_slave_agent:cp_ready -> cmd_mux:src_ready
	wire   [3:0] cmd_mux_src_channel;                                                              // cmd_mux:src_channel -> sysid_qsys_0_control_slave_agent:cp_channel
	...
	wire  [83:0] cmd_mux_001_src_data;                                                             // cmd_mux_001:src_data -> pio_0_s1_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                            // pio_0_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [3:0] cmd_mux_001_src_channel;                                                          // cmd_mux_001:src_channel -> pio_0_s1_agent:cp_channel
	...
	wire  [84:0] pio_1_s1_agent_rf_source_data;                                                    // pio_1_s1_agent:rf_source_data -> pio_1_s1_agent_rsp_fifo:in_data
	...
	wire  [84:0] pio_1_s1_agent_rsp_fifo_out_data;                                                 // pio_1_s1_agent_rsp_fifo:out_data -> pio_1_s1_agent:rf_sink_data
	...
	wire  [83:0] cmd_mux_002_src_data;                                                             // cmd_mux_002:src_data -> pio_1_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                            // pio_1_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [3:0] cmd_mux_002_src_channel;                                                          // cmd_mux_002:src_channel -> pio_1_s1_agent:cp_channel
	...
	wire  [11:0] timer_0_s1_agent_m0_address;                                                      // timer_0_s1_agent:m0_address -> timer_0_s1_translator:uav_address
	...
	wire  [84:0] timer_0_s1_agent_rf_source_data;                                                  // timer_0_s1_agent:rf_source_data -> timer_0_s1_agent_rsp_fifo:in_data
	...
	wire  [84:0] timer_0_s1_agent_rsp_fifo_out_data;                                               // timer_0_s1_agent_rsp_fifo:out_data -> timer_0_s1_agent:rf_sink_data
	...
	wire  [83:0] cmd_mux_003_src_data;                                                             // cmd_mux_003:src_data -> timer_0_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                            // timer_0_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [3:0] cmd_mux_003_src_channel;                                                          // cmd_mux_003:src_channel -> timer_0_s1_agent:cp_channel
	...
	wire  [83:0] sysid_qsys_0_control_slave_agent_rp_data;                                         // sysid_qsys_0_control_slave_agent:rp_data -> router_001:sink_data
	...
	wire  [83:0] pio_0_s1_agent_rp_data;                                                           // pio_0_s1_agent:rp_data -> router_002:sink_data
	...
	wire  [83:0] pio_1_s1_agent_rp_data;                                                           // pio_1_s1_agent:rp_data -> router_003:sink_data
	...
	wire  [83:0] timer_0_s1_agent_rp_data;                                                         // timer_0_s1_agent:rp_data -> router_004:sink_data
	...
	wire   [3:0] mm_clock_crossing_bridge_0_m0_limiter_cmd_src_channel;                            // mm_clock_crossing_bridge_0_m0_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire   [3:0] rsp_mux_src_channel;                                                              // rsp_mux:src_channel -> mm_clock_crossing_bridge_0_m0_limiter:rsp_sink_channel
	...
	wire  [83:0] cmd_demux_src1_data;                                                              // cmd_demux:src1_data -> crosser:in_data
	...
	wire  [83:0] crosser_out_data;                                                                 // crosser:out_data -> cmd_mux_001:sink0_data
	...
	wire  [83:0] cmd_demux_src3_data;                                                              // cmd_demux:src3_data -> crosser_001:in_data
	...
	wire  [83:0] crosser_001_out_data;                                                             // crosser_001:out_data -> cmd_mux_003:sink0_data
	...
	wire  [83:0] rsp_demux_001_src0_data;                                                          // rsp_demux_001:src0_data -> crosser_002:in_data
	...
	wire  [83:0] crosser_002_out_data;                                                             // crosser_002:out_data -> rsp_mux:sink1_data
	...
	wire  [83:0] rsp_demux_003_src0_data;                                                          // rsp_demux_003:src0_data -> crosser_003:in_data
	...
	wire  [83:0] crosser_003_out_data;                                                             // crosser_003:out_data -> rsp_mux:sink3_data
	...
	wire   [3:0] mm_clock_crossing_bridge_0_m0_limiter_cmd_valid_data;                             // mm_clock_crossing_bridge_0_m0_limiter:cmd_src_valid -> cmd_demux:sink_valid
	...
	core_mm_interconnect_1_router router (
	...
	core_mm_interconnect_1_router_001 router_001 (
	...
	core_mm_interconnect_1_router_001 router_002 (
	...
	core_mm_interconnect_1_router_001 router_003 (
	...
	core_mm_interconnect_1_router_001 router_004 (
	...
	core_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (altpll_0_c2_clk),                                                 //        clk.clk
		.reset              (mm_clock_crossing_bridge_0_m0_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	core_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (altpll_0_c2_clk),                                                 //       clk.clk
		.reset               (mm_clock_crossing_bridge_0_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	core_mm_interconnect_1_cmd_mux cmd_mux_001 (
		.clk                 (altpll_0_c0_clk),                         //       clk.clk
		.reset               (pio_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	core_mm_interconnect_1_cmd_mux cmd_mux_002 (
		.clk                 (altpll_0_c2_clk),                                                 //       clk.clk
		.reset               (mm_clock_crossing_bridge_0_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	core_mm_interconnect_1_cmd_mux cmd_mux_003 (
		.clk                 (altpll_0_c0_clk),                         //       clk.clk
		.reset               (pio_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	core_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (altpll_0_c2_clk),                                                 //       clk.clk
		.reset              (mm_clock_crossing_bridge_0_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	core_mm_interconnect_1_rsp_demux_001 rsp_demux_001 (
		.clk                (altpll_0_c0_clk),                         //       clk.clk
		.reset              (pio_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	core_mm_interconnect_1_rsp_demux rsp_demux_002 (
		.clk                (altpll_0_c2_clk),                                                 //       clk.clk
		.reset              (mm_clock_crossing_bridge_0_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	core_mm_interconnect_1_rsp_demux_001 rsp_demux_003 (
		.clk                (altpll_0_c0_clk),                         //       clk.clk
		.reset              (pio_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	core_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (altpll_0_c2_clk),                                                 //       clk.clk
		.reset               (mm_clock_crossing_bridge_0_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.out_reset         (pio_0_reset_reset_bridge_in_reset_reset),                         // out_clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.in_reset          (pio_0_reset_reset_bridge_in_reset_reset),                         //  in_clk_reset.reset
